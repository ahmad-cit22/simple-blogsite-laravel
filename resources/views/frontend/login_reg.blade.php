        ...
        <div class="container">
            <div class="row align-items-start justify-content-between">
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                    ...
                    <form action="{{ route('blogger.login') }}" method="POST" class="border p-3 rounded">
                        @csrf
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mfliud">
                    ...
                    <form action="{{ route('blogger.signup') }}" method="POST" class="border p-3 rounded">
                        @csrf
                        <div class="row">
