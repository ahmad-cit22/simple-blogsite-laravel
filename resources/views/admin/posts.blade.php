...
<head>
    <title>BLOGSITE - Admin Dashboard | Users List</title>
...
<body>
    ...
    <div class="nav-header">
        <a href="{{ route('home') }}" class="brand-logo text-info">
            <h1>BLOGSITE</h1>
        </a>
        ...
        <div class="deznav-scroll">
            <ul class="metismenu" id="menu">
                ...
                <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                    ...
                    <ul aria-expanded="false">
                        <li><a href="{{ route('users') }}">User List (Admin)</a></li>
                        <li><a href="{{ route('bloggers') }}">User List (Blogger)</a></li>
                    </ul>
                </li>
                <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        <i class="flaticon-381-television"></i>
    ...
    <div class="content-body">
        ...
        <div class="container-fluid">
            <div class="row">
                <h3>Users List (Blogger)</h3>
                <div class="col-12 table-responsive">
                    <table class="table table-bordered blogger_datatable">
                        <thead>
                            <tr>
                                <th class="text-center">SL</th>
                                <th class="text-center">Blogger ID</th>
                                <th>Blog Title</th>
                                <th>Blog Body</th>
                                <th>Action</th>
                            </tr>
...
<script type="text/javascript">
    $(function() {
        var table = $('.blogger_datatable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('posts') }}",
            columns: [{
