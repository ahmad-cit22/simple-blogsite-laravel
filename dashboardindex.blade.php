...
<html lang="en">
    <head>
        ...
        <link
            href="{{
                asset(
                    'dashboard/vendor/bootstrap-select/dist/css/bootstrap-select.min.css'
                )
            }}"
            rel="stylesheet"
        />
        <link
            href="{{ asset('dashboard/vendor/owl-carousel/owl.carousel.css') }}"
            rel="stylesheet"
        />
            ...
            <div class="chatbox">
                ...
                <div class="custom-tab-1">
                    ...
                    <div class="tab-content">
                        ...
                        >
                            <div
                                class="card mb-sm-3 mb-md-0 contacts_card dz-chat-user-box"
                            >
                                <div
                                    class="card-header chat-list-header text-center"
                                >
                                    ...
                                    <div class="dropdown">
                                        ...
                                        >
                                            <li class="dropdown-item">
                                                <i
                                                    class="fa fa-user-circle text-primary mr-2"
                                                ></i>
                                                View profile
                                            </li>
                                            <li class="dropdown-item">
                                            ...
                                            <li class="dropdown-item">
                                                <i
                                                    class="fa fa-ban text-primary mr-2"
                                                ></i>
                                                Block
                                            </li>
                                        </ul>
                                ...
                                >
                                    ...
                                    >
                                        <div class="msg_cotainer_send">
                                            Hi Khalid i am good tnx how about
                                            you?
                    ...
                    <nav class="navbar navbar-expand">
                        ...
                        >
                            ...
                            <ul class="navbar-nav header-right">
                                <li class="nav-item">
                                    <div
                                        class="input-group search-area d-xl-inline-flex d-none"
                                    >
                                        <div class="input-group-append">
                                ...
                                <li class="nav-item dropdown header-profile">
                                    ...
                                    >
                                        <img
                                            src="{{
                                                asset(
                                                    'dashboard/images/profile/17.jpg'
                                                )
                                            }}"
                                            width="20"
                                            alt=""
        ...
        ***********************************-->
            <div class="deznav">
                <div class="deznav-scroll">
                            ...
                            <ul aria-expanded="false">
                                ...
                                <li>
                                    ...
                                    <ul aria-expanded="false">
                                        ...
                                        <li>
                                            <a href="./ecom-checkout.html"
                                                >Checkout</a
                                            >
                                        </li>
                                        <li>
                                            <a href="./ecom-invoice.html"
                                                >Invoice</a
                                            >
                                        </li>
                                        <li>
                                            <a href="./ecom-customers.html"
                                                >Customers</a
                                            >
                                        </li>
                                    </ul>
                    ...
                    <div class="copyright">
                        <p>
                            <strong>Gymove Fitness Admin Dashboard</strong> ©
                ...
                <div class="container-fluid">
                    <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="card avtivity-card">
                                        <div class="card-body">
                                            ...
                                            >
                                                <span
                                                    class="activity-icon bgl-success mr-md-4 mr-3"
                                                >
                                                    <svg
                                                        width="40"
                                                        height="40"
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <span
                                                        class="title text-black font-w600"
                                                        >42%</span
                                                    >
                                                </div>
                                            </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="card avtivity-card">
                                        <div class="card-body">
                                            ...
                                            >
                                                <span
                                                    class="activity-icon bgl-secondary mr-md-4 mr-3"
                                                >
                                                    <svg
                                                        width="40"
                                                        height="37"
                                ...
                                <div class="col-sm-6">
                                    <div class="card avtivity-card">
                                        <div class="card-body">
                                            ...
                                            >
                                                <span
                                                    class="activity-icon bgl-danger mr-md-4 mr-3"
                                                >
                                                    <svg
                                                        width="40"
                                                        height="39"
                                ...
                                <div class="col-sm-6">
                                    <div class="card avtivity-card">
                                        <div class="card-body">
                                            ...
                                            >
                                                <span
                                                    class="activity-icon bgl-warning mr-md-4 mr-3"
                                                >
                                                    <svg
                                                        width="40"
                                                        height="40"
                        ...
                        <div class="col-xl-6 col-xxl-12">
                            <div class="card">
                                <div
                                    class="card-header d-sm-flex d-block pb-0 border-0"
                                >
                                    ...
                                    <div class="card">
                                        ...
                                        >
                                            <div class="mr-auto pr-3">
                                                <h4
                                                    class="text-black font-w600 fs-20"
                                                >
                                                    Recomended Trainer for You
                                                </h4>
                                                <p
                                                    class="fs-13 mb-0 text-black"
                                                >
                                                    Lorem ipsum dolor sit amet,
                                                    consectetur
                                                </p>
                                            ...
                                            <a
                                                href="food-menu.html"
                                                class="btn btn-primary rounded d-none d-md-block"
                                                >View More</a
                                            >
                                        </div>
                                        <div class="card-body pt-2">
                                            <div
                                                class="testimonial-one owl-carousel"
                                            >
                                                <div class="items">
                                                    <div
                                                    ...
                                                    >
                                                        <div class="card-body">
                                                            ...
                                                            >
                                                                ...
                                                                <span
                                                                    class="fs-14 d-block ml-2 pr-2 mr-2 border-right text-black font-w500"
                                                                    >4.4</span
                                                                >
                                                                <a
                                                                    href="app-profile.html"
                                                                    class="btn-link fs-14"
                                                                    >Send
                                                                    Request</a
                                                                >
                                                            </div>
                                ...
                                <div class="col-xl-12">
                                    <div class="card">
                                        ...
                                        >
                                            <div class="mr-auto pr-3">
                                                <h4
                                                    class="text-black fs-20 font-w600"
                                                >
                                                    Calories Chart
                                                </h4>
                                                <p
                                            ...
                                            <div class="dropdown mt-sm-0 mt-3">
                                                <button
                                                    type="button"
                                                    class="btn rounded btn-primary dropdown-toggle"
                                                    data-toggle="dropdown"
                                                    aria-expanded="false"
                                                >
                                                    Weekly
                                ...
                                <div class="col-xl-12">
                                    <div class="card featuredMenu">
                                        <div class="card-header border-0">
                                            <h4
                                                class="text-black font-w600 fs-20 mb-0"
                                            >
                                                Featured Diet Menu
                                            </h4>
                                        </div>
                                        <div
                                            class="card-body loadmore-content height750 dz-scroll pt-0"
                                        ...
                                        >
                                            <div class="media mb-4">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <span
                                                        class="fs-14 text-primary font-w500"
                                                        >Kevin Ignis</span
                                                    >
                                                </div>
                                            </div>
                                            ...
                                            >
                                                <li class="mr-3 mb-2">
                                                    <i
                                                        class="las la-clock scale5 mr-3"
                                                    ></i
                                                    ><span
                                                ...
                                                <li class="mb-2">
                                                    ...
                                                    ></i
                                                    ><span
                                                        class="fs-14 text-black font-w500"
                                                        >176 Reviews</span
                                                    >
                                                </li>
                                            </ul>
                                        ...
                                        <div
                                            class="card-footer style-1 text-center border-0 pt-0 pb-4"
                                        >
                                            <a
                                                class="text-primary dz-load-more fa fa-chevron-down"
                                                id="FeaturedMenus"
                                                href="javascript:void(0);"
                                                rel="ajax/featured-menu-list.html"
                                            >
                                            </a>
                                        </div>
                                    </div>
    ...
    ***********************************-->
        <!-- Required vendors -->
        <script src="{{
                asset('dashboard/vendor/global/global.min.js')
            }}"></script>
        <script src="{{
                asset(
                    'dashboard/vendor/bootstrap-select/dist/js/bootstrap-select.min.js'
                )
            }}"></script>
        <script src="{{
                asset('dashboard/vendor/chart.js/Chart.bundle.min.js')
            }}"></script>
        <script src="{{ asset('dashboard/js/custom.min.js') }}"></script>
        <script src="{{ asset('dashboard/js/deznav-init.js') }}"></script>
        <script src="{{
                asset('dashboard/vendor/owl-carousel/owl.carousel.js')
            }}"></script>

        <!-- Chart piety plugin files -->
        <script src="{{
                asset('dashboard/vendor/peity/jquery.peity.min.js')
            }}"></script>

        <!-- Apex Chart -->
        <script src="{{
                asset('dashboard/vendor/apexchart/apexchart.js')
            }}"></script>

        <!-- Dashboard 1 -->
        <script src="{{
                asset('dashboard/js/dashboard/dashboard-1.js')
            }}"></script>
        <script>
